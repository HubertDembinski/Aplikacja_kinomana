  ...
  <body>
    ...
    <div class = "tytul-akt">
      Komedia
           ...
           <?php
        $result2 = mysqli_query($connection, "SELECT idf, nazwa_film, miniatura, kategorie.nazwa, rok, rezyser, plik FROM filmy INNER JOIN kategorie ON filmy.idk = kategorie.idk WHERE filmy.idk = 2;") or die ("DB error: $dbname");
